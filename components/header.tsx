    ...
    <header className="sticky top-0 z-50 w-full border-b border-primary/20 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link href="#projects" className="text-sm font-medium text-primary hover:text-secondary transition-colors">
            Projects
          </Link>
        ...
        <div className="flex items-center gap-4">
          <Link href="https://github.com/Mcootauc" target="_blank">
            <Button variant="ghost" size="icon" className="text-primary hover:text-secondary hover:bg-primary/10">
          ...
          <Link href="/SweInternshipResumeJune2024.pdf" target="_blank">
            <Button className="bg-secondary hover:bg-secondary/90">Resume</Button>
          </Link>
        </div>
      </div>
    </header>
