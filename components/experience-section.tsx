...
const experiences = [
    ...
    },
    {
        ...
        responsibilities: [
            'Spearheaded a client project for a <strong>multi-billion-dollar</strong> short-term rental company by directing product development teams to curate a front-end interface for <strong>23,000</strong> monthly active homeowner stakeholders',
            'Created an improved version of the client’s web app using <strong>Vue</strong> and <strong>Firebase</strong> to store and display information',
            'Managed a GitHub repository for a <strong>10-member Agile</strong> team, overseeing commits and approving pull requests',
        ],
    },
    {
        ...
        responsibilities: [
            'Launched social OAuth routes using <strong>TypeScript</strong> and <strong>Python</strong>, increasing account security for users',
            'Created a Partner user schema by writing <strong>SQL</strong> for tables and queries for data control, enabling a new user role',
            'Enhanced the user dashboard utilizing <strong>Next.js</strong> and <strong>TypeScript</strong>, ensuring a dynamic and responsive user interface',
            'Containerized <strong>15 FastAPI</strong> endpoints with <strong>Docker</strong> and deployed via <strong>AWS Lambda</strong>, cutting release time by <strong>88%</strong>',
        ],
    },
    {
        ...
        responsibilities: [
            'Optimized database schema with <strong>Prisma</strong>, improving data management for user profiles, venues, and images',
            'Deployed a <strong>Next.js</strong> large-scale web app using <strong>React</strong> and <strong>TypeScript</strong>, enabling auto-fill search for venue requests',
    ...
    },
    {
        ...
        location: 'Los Angeles, CA',
        responsibilities: [
            'Developed an automated client registration system using <strong>React Native Expo</strong> and <strong>Supabase</strong> that reduced new client entry time by <strong>20%</strong> and removed data-entry errors, allowing vet techs more time to help clients and pets',
            'Integrated a Chrome extension to auto-populate new client information into vet management software, which simplified workflow and minimized manual data handling, raising the number of new clients by <strong>5%</strong> every month',
            'Deployed a <strong>Next.js</strong> web app displaying client data, enabling vet technicians to view and copy registrations',
        ],
    },
    {
